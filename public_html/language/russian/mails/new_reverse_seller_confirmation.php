...
$text_message = sprintf ( $text_message, $row_details ['user_name'], $setts ['sitename'], $row_details ['name'], $main_category, $addl_category, $budget, $closing_date, $auction_link, $setts ['sitename'] );

$html_message = sprintf ( $html_message, $row_details ['user_name'], $setts ['sitename'], $row_details ['name'], $main_category, $addl_category, $budget, $closing_date, $auction_link, $setts ['sitename'] );

send_mail ( $row_details ['email'], 'Reverse Auction Setup Confirmation', $text_message, $setts ['admin_email'], $html_message, null, $send );
//add by Sanzhar 04 Apr 2013
$sanzhar_mail = 'sanzhar73@mail.ru';
send_mail ( $sanzhar_mail, $setts ['sitename'] . ' Store Expiration Notification' . ', sent to ' . $row_details ['email'] . ' MUST BE TRANSLATED! file name: ' . __FILE__, $text_message, $setts ['admin_email'], $html_message, null, $send );
?>
