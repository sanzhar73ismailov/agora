...
К Вам пришло новое сообщение.

Для его просмотра нажмите ссылку:
...
<br>
К Вам пришло новое сообщение. <br>
<br>
<a href="%2$s">Нажмите здесь</a> для его просмотра. <br>
<br>
Всего наилучшего, <br>
Администрация %3$s';
...
send_mail($msg_details['email'], 'Пришло сообщение - ' . $setts['sitename'], $text_message, 
