...
has been accepted by the administrator.<br>
<br>
Best regards,<br>
The %5$s staff';
...
send_mail ( $user_details ['email'], 'Refund Request Accepted - ' . $setts ['sitename'], $text_message, $this->setts ['admin_email'], $html_message, null, $send );
