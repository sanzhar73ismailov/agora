...
define ('MSG_QUANTITY_EXPL', 'Enter the number of items you are offering for sale.<br>
To list a dutch auction, enter a quantity >1.');
...
two-letter abbreviation for the name of the state, possession, or territory.<br><br>
For Canadian addresses: For the element "Country" use the value "CA". For "State" you should use a standard Canadian two-letter 
abbreviation for the name of the province or territory. <br><br>
...
define ('MSG_PAYPAL_COUNTRY_EXPL', 'Enter the official 2 letter country abbreviation.');
...
define ('MSG_PHONE_NEW_EXPL', 'Enter your phone number, following the recommended formats below:<br>
<b>US</b>: 3 digit area code - 3 digit phone prefix - 3 digit phone number (Example: <b>212-555-1234</b>)<br>
<b>Non US</b>: country code - full phone number (Example: <b>44-20 1234 5678</b>)');
define ('MSG_OPERATION_IN_PROGRESS', 'Please wait, your operation is in progress...');
define ('MSG_WAIT_UPL_PROGRESS', 'Uploading, please wait...');
define ('MSG_SWAP_FEE_APPLIED_EXPL', 'The swap fee will be applied when the item is swapped.');
define ('MSG_ALLOW_STORE_SUBSCRIPTION_EXPL', '<b>Important</b>: You can upgrade your store subscription by only paying the amount difference between your current subscription and the new subscription you plan to order.');
define ('MSG_IMPORT_FAILED', '<b>Error</b>: The import failed.');
define ('MSG_PROCESSING_BULK_LISTINGS', 'The file has been uploaded.<br>Processing your listings. Please wait, this might take a few minutes...');
define ('MSG_PLEASE_WAIT_PROCESSING', 'Please wait, processing...');
define ('MSG_IMPORT_LISTINGS_ERROR', 'The following listings could not be imported');
define ('MSG_LISTINGS_IMPORTED', 'listings imported');
define ('MSG_MASS_DELETE_OPEN_ITEMS', 'Mass Delete Open Items');
define ('MSG_MASS_DELETE_OPEN_ITEMS_CONFIRM', 'Are you sure that you want to delete all your open items which have no bids placed?\n\nThis operation cannot be undone!');
define ('MSG_OPEN_ITEMS_MASS_DELETED_SUCCESS', 'All your open items without bids have been deleted successfully.');
define ('MSG_AUCTION_PREVIEW', 'Auction Preview');

/* begin - bulk lister template translation */
define ('MSG_BT_TITLE', 'Bulk Upload File Schema');
define ('MSG_BT_DELIMITER_DESCRIPTION', '<p>Below is the list of fields you can upload for your auctions, along with their format and/or accepted values.</p>
<p>In your file, each auction is represented by a row and the fields must be delimited by a 
' . (($setts['csv_delimiter'] == 'comma') ? 'comma (<strong>,</strong>)' : 'semicolon (<strong>;</strong>)') . '</p>');
define ('MSG_FIELD_NAME', 'Field Name');
define ('MSG_FIELD_TYPE', 'Field Type');
define ('MSG_ACCEPTED_VALUES', 'Accepted Values');
define ('MSG_MANDATORY', 'Mandatory');
define ('MSG_NOTES', 'Notes');
define ('MSG_CATEGORIES_IDS', 'Categories IDs');
define ('MSG_BT_CUSTOM_FIELDS_EXPL1', 'The custom fields will need to be added in the bulk file in the following format:<br>
<b>id1</b>::<b>value1</b>|<b>id2</b>::<b>value2</b>|<b>id3</b>::<b>value3</b>');
define ('MSG_BT_CUSTOM_FIELDS_EXPL2', 'If the custom field is a checkbox, the value field will have the following format:<br>
<b>value1</b>,<b>value2</b>,<b>value3</b>');
define ('MSG_BOX_FIELD_NAME', 'Box/Field Name');
define ('MSG_BOX_TYPE', 'Box Type');
define ('MSG_COUNTRIES_IDS', 'Countries IDs');
define ('MSG_COUNTRY_NAME', 'Country Name');
define ('MSG_COUNTRY_ID', 'Country ID');
define ('MSG_BULK_LISTER', 'Bulk Lister');
define ('MSG_INSTRUCTIONS', 'Instructions');
define ('MSG_BULK_LISTER_DESCRIPTION', '<p>
In order to be able to upload auctions using our new bulk lister tool, please check the structure of the file. For certain fields, you will only be 
allowed to enter specific values. 
You can also download the sample csv file to get an idea how the structure of a bulk csv file should look like.				
</p>
<p>The fields will be separated by the ' . (($setts['csv_delimiter'] == 'comma') ? 'comma (<strong>,</strong>)' : 'semicolon (<strong>;</strong>)') . ' character, 
making the ' . (($setts['csv_delimiter'] == 'comma') ? 'comma (<strong>,</strong>)' : 'semicolon (<strong>;</strong>)') . '
and the vertical bar (|) reserved characters.</p>
<p>Due to the restriction above, any field containing a 
' . (($setts['csv_delimiter'] == 'comma') ? 'comma (<strong>,</strong>)' : 'semicolon (<strong>;</strong>)') . '
...
<p><b>Important</b>: When creating a csv file with Excel or a similar csv creating tool, there is no need to add quotes and double quotes, 
because Excel will automatically add these for you if a field contains quotes and 
' . (($setts['csv_delimiter'] == 'comma') ? 'commas' : 'semicolons') . '.</p>
...
define ('MSG_DOWNLOAD_SAMPLE_FILE', 'Download Sample File');
define ('MSG_UPLOAD_BULK_FILE', 'Upload Bulk File');
define ('MSG_LISTING_ITEMS_TOTAL', 'Listing all of the items below will total');
define ('MSG_IN_LISTING_FEES', 'in listing fees');

/* end - bulk lister template translation */
define ('MSG_RENEW_SUBSCRIPTION', 'Renew Subscription');

define ('MSG_BIDDER', 'Bidder');
define ('MSG_PROXY_BIDDER_EXPL_1', 'is currently leading the auction as they have  
a proxy bid higher than the current losing bidder');
define ('MSG_PROXY_BIDDER_EXPL_2', 'To  
take the lead on the auction a new bid needs to be placed to surpass  
the proxy bid of');
define ('', '');
define ('', '');
