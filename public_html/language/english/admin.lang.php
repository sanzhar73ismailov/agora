...
define ('AMSG_SELLER_VERIF_REFUND_EXPL', 'If the checkbox above is checked, the verification fee will be credited to the user\'s account after payment.<br>
...
define ('AMSG_STORE_LISTINGS', 'Store Listings');
define ('AMSG_STANDARD_STORE', 'Standard (v6.07)');
define ('AMSG_ALTERNATIVE_STORE', 'Alternative (v6.10)');
define ('AMSG_STANDARD_STORE_EXPL', 'This enables store owners to set an auction duration for their store listed items and also list both auctions and fixed priced items.');
define ('AMSG_ALTERNATIVE_STORE_EXPL', 'This enables store owners to list items with no duration (listed until removed by the seller or sold) and also only permits fixed priced items.');
define ('AMSG_ENABLE_STORE_UPGRADE', 'Allow Store Upgrades');
define ('AMSG_ENABLE_STORE_UPGRADE_EXPL', 'If you enable this option, store owners will be able to upgrade their store by only paying the subscription difference instead of the full amount of the new subscription.');
define ('AMSG_STORE_UPGRADE_DAYS', 'Min. Upgrade Days');
define ('AMSG_STORE_UPGRADE_DAYS_EXPL', 'Enter the minimum number of days until a store subscription expires where store owners are able to upgrade their subscription by only paying the difference amount.');
define ('AMSG_VERIFIED_BIDDERS', 'Verified Bidders');
define ('AMSG_THUMB_DISPLAY', 'Auction Details Page Thumbnails');
define ('AMSG_THUMB_DISPLAY_H', 'Top Left (New)');
define ('AMSG_THUMB_DISPLAY_V', 'Under Description (Old)');
define ('AMSG_THUMB_DISPLAY_EXPL', 'Choose where the images thumbnails will appear on the auction details page.');
define ('AMSG_OPERATION_COMPLETE', 'Operation Completed');
define ('', '');
?>