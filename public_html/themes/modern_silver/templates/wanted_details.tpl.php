...
<table width='100%' border='0' cellspacing='0' cellpadding='0' height='21' style='border-bottom: 2px solid #a6a6a6;'>
        ...
        <td width='100%' background='themes/<?=$setts['default_theme'];?>/img/det_bg.gif' valign='bottom' class='cathead' style='padding-left: 5px; padding-bottom: 3px;'>
<table width="100%" border="0" cellpadding="0" cellspacing="0">
   <tr>
      <td class="itemid">&nbsp;&nbsp;<?=$item_details['name'];?></td>
      <td align="right" class="itemidend"><?=MSG_WANTED_AD_ID;?>: <b><?=$item_details['wanted_ad_id'];?></b>&nbsp;&nbsp;</td>
   </tr>
</table>
        	</td>
